...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_create_question(self):
        res = self.client().post('/questions', json={"question":"the greatest showman", "answer":"Hugh Jackman", "category":"5", "difficulty":1})
        data = json.loads(res.data)
    ...
    def test_405_create_not_allowed(self):
        res = self.client().post('/questions/1', json={"question":"the greatest showman", "answer":"Hugh Jackman", "category":"5", "difficulty":1})
        data = json.loads(res.data)
    ...
    def test_search_questions_no_results(self):
        res = self.client().post('/questions/search', json={"searchTerm":"fyyur"})
        data = json.loads(res.data)
    ...
    def test_play_quizzes(self):
        res = self.client().post('/quizzes', json={"previous_questions": [2],"quiz_category": {"type":"Geography","id": "2"}})
        data = json.loads(res.data)
